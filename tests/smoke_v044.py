#!/usr/bin/env python3
"""Smoke tests for Entity Distance v0.4.4 — altitude, GPS attrs, person source fallback.

Run against a live HA instance with test entities injected.
Usage:
    python3 tests/smoke_v044.py
...
def test_altitude_sensors():
    ...
    inject("device_tracker.test_bob", 53.3512, -6.2603, altitude=50.0)
    time.sleep(3)
...
def test_same_altitude_threshold():
    ...
    inject("device_tracker.test_bob", 53.3512, -6.2603, altitude=103.0)
    time.sleep(2)
    inject("device_tracker.test_alice", 53.3498, -6.2603, altitude=100.0)
    inject("device_tracker.test_bob", 53.3512, -6.2603, altitude=103.0)
    time.sleep(4)
...
if __name__ == "__main__":
    print("\nEntity Distance v0.4.4 Smoke Tests")
